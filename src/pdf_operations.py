...
def merge_pdf_files(
    ...
    Args:
        files_to_merge (List[Dict[str, Any]]): A list of dictionaries, each containing:
            path (Path): The path to the PDF file.
            pages (Optional[Tuple[int, int]]): The (start, end) page range to include, or None for all pages.
            description (str): Description of the file for logging.
        output_path (Path): The path where the merged PDF will be saved.
